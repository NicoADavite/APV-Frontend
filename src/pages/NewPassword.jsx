			...
			<div className="mt-12 md:mt-5 shadow-lg shadow-indigo-200 px-6 py-10 rounded-xl bg-white">
				{cargando && (
					<button
						disabled
						type="button"
						className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-bold rounded-lg text-3xl mx-auto px-8 py-4 text-center my-40 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 flex justify-center items-center"
					>
						<svg
							role="status"
